# Tashfeer Project Workflow

This document illustrates the end-to-end workflow of the Tashfeer RAG system, detailing the Data Ingestion Pipeline and the RAG Inference Pipeline.
